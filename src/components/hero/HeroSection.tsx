...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    if (subRef.current) {
      tl.fromTo(subRef.current, { y: 30, opacity: 0 }, { y: 0, opacity: 1, duration: 0.8, ease: "power3.out" }, "-=0.3");
    }
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col items-center gap-8 px-6 pt-24 lg:flex-row lg:gap-16 lg:pt-0">
        <div className="flex-1 text-center lg:text-left">
          ...
          <p ref={subRef} className="mb-2 font-body text-lg text-gray-400 sm:text-xl">
          ...
          <div ref={ctaRef} className="flex flex-col items-center gap-4 sm:flex-row lg:justify-start">
      ...
      <div className="absolute bottom-8 left-1/2 z-10 -translate-x-1/2 animate-float">
        <div className="flex flex-col items-center gap-2">
          <span className="font-pixel text-[7px] tracking-widest text-purple-500/60">SCROLL</span>
